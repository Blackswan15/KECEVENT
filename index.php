                ...
                <div class="sidebar">
                    <div class="quickaccess">
                        ...
                        <ul type="none" class="list-group list-group-flush">
                            ...
                            <li class="list-group-item border-0 p-2"><a href="#hockey" class="text-decoration-none">Hockey</a></li><li class="list-group-item border-0 p-2"><a href="#paperpresentation" class="text-decoration-none">Paper Presentation</a></li><li class="list-group-item border-0 p-2"><a href="#aiworkshop" class="text-decoration-none">AI Workshop</a></li><li class="list-group-item border-0 p-2"><a href="#raaga'25" class="text-decoration-none">Raaga'25</a></li><li class="list-group-item border-0 p-2"><a href="#art25" class="text-decoration-none">Art\'25</a></li><li class="list-group-item border-0 p-2"><a href="#blackswanadanceofdrama" class="text-decoration-none">BlackSwan - A Dance of Drama</a></li><li class="list-group-item border-0 p-2"><a href="#logiclabyrinth2025" class="text-decoration-none">Logic Labyrinth\'2025</a></li></ul>
                    </div>
